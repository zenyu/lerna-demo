...
const normal = {
    host, // 服务域名、IP
    index: host, // 产品线首页地址
    login: `${host}/login`, // 登录页地址
    newLc: host.indexOf('youdongxi') !== -1
        ? 'http://layercake.youdongxi.com'
        : `${host}/layercake`, // 改版后的lc地址
};

// 本地开发环境
if (process.env.NODE_ENV === 'development') {
    other = {
        lc: 'http://www.layercake.com.cn', // 改版前lc地址
        sso: '', // sso 数据接口
    };
}
