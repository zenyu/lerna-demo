...
module.exports = function (opts, config) {
  ...
  var isEnvDevelopment = environment === 'development';
  ...
  return merge({
    mode: ['development', 'production', 'none'].includes(environment) ? process.env.NODE_ENV : 'production',
    entry: paths.appIndexJs,
    output: {
      path: paths.appDist,
      // 生成的文件存放路径
      filename: 'index.js',
      // 生成的文件名字(默认为 index.js)
      library: name,
      // 包名
      libraryTarget: 'umd',
      globalObject: 'this'
